...
- The trust model — including what compact filters can and cannot guarantee
  ...
  [docs/read-side.md](docs/read-side.md). Reports about the *design* belong
  there as issues; reports about the *implementation* not matching that design
  are security reports.
